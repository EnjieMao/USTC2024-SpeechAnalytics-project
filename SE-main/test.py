...
for method in method_list:
    ...
    for data in test_data:
        ...
        audio_clean = librosa.load(clean_path, sr=None)[0]
        udio_clean = librosa.load(clean_path, sr=None)[1]
        audio_noisy = librosa.load(noisy_path, sr=None)[0]
